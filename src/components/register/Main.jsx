                                                        ...
                                                        <div className="mb-[20px] text-inherit" style={{ color: 'rgb(0, 0, 0, 1)' }} >
                                                            <form onSubmit={handleGo} className="border-0 flex flex-col text-inherit m-0 max-w-[350px] p-0 align-baseline">
                                                                ...
                                                                <div className="spacing">
                                                                    <div>
                                                                        <label className="label1">
                                                                            <input aria-label="Contraseña" placeholder="" className={`inputName border ${errors.password ? '!border-red-500' : 'dark:!border-[#555555]'}`} aria-required="true" value={password} onChange={(e) => { setPassword(e.target.value); if (touched.password) { validatePassword(e.target.value) } }} onBlur={(e) => { setTouched(prev => ({ ...prev, password: true })); setErrors(prev => ({ ...prev, password: validatePassword(e.target.value) })) }} autoCapitalize="off" autoCorrect="off" maxLength="75" type={showPassword ? "text" : "password"} name="password" required />
