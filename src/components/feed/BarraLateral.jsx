...
function Aside() {
  ...
  return (
    <>
      <div className="max-md:hidden container-aside overflow-visible w-fit h-screen top-0 fixed bg-transparent dark:bg-[#ffffff] flex-col flex items-stretch self-auto justify-start z-10 text-[#000000] dark:text-[#ffffff] text-sm leading-[18px]">
        <div className=" max-h-[inherit] h-[inherit] min-h-[inherit] w-[inherit] max-w-[inherit] justify-inherit relative ">
          <div className=" h-dvh flex justify-between flex-row relative ">
            <div className="translate-x-0 border border-[#DBDBDB] z-[1] ">
              <div className="translate-0 pb-[20px] pt-[8px] nav-rangeLg h-dvh bg-[#ffffff] px-[12px] flex-col flex items-start">
                          ...
                          <div className="[@media(min-height:600px)]:my-[4px] [@media(min-height:1264px)]:p-[12px]  [@media(min-height:1264px)]:flex-row [@media(min-height:1264px)]:w-full p-[12px] rounded-[8px] [@media(min-width:1264px)]:w-[220px] [@media(max-width:1264px)]:w-[47px] hover:bg-[#F5F5F5] inline-flex">
                            <div>
                              <div className="overflow-visible flex-col flex bg-transparent items-stretch justify-start relative self-auto w-[24px] h-[24px] transition duration-200">
                                <svg aria-label="Inicio" height="24" role="img" viewBox="0 0 24 24" width="24"><title>Inicio</title><path d="M9.005 16.545a2.997 2.997 0 0 1 2.997-2.997A2.997 2.997 0 0 1 15 16.545V22h7V11.543L12 2 2 11.543V22h7.005Z" fill="black" stroke="black" stroke-linejoin="round" stroke-width="2"></path></svg>
                              </div>
                            </div>
                    ...
                    <span className="text-decoration-none flex items-center relative">
                      <a className="text-decoration-none  border-none inline bg-transparent touch-manipulation cursor-pointer outline-none ">
                        <div className="[[@media(min-height:600px)]:my-[4px] [@media(min-height:1264px)]:p-[12px]  [@media(min-height:1264px)]:flex-row [@media(min-height:1264px)]:w-full p-[12px] rounded-[8px] [@media(min-width:1264px)]:w-[220px] [@media(max-width:1264px)]:w-[47px] hover:bg-[#F5F5F5] inline-flex">
                          <div>
                            <div className="overflow-visible flex-col flex bg-transparent items-stretch justify-start relative self-auto w-[24px] h-[24px] transition duration-200">
                              <svg aria-label="Búsqueda" class="x1lliihq x1n2onr6 x5n08af" fill="currentColor" height="24" role="img" viewBox="0 0 24 24" width="24"><title>Búsqueda</title><path d="M19 10.5A8.5 8.5 0 1 1 10.5 2a8.5 8.5 0 0 1 8.5 8.5Z" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"></path><line fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" x1="16.511" x2="22" y1="16.511" y2="22"></line></svg>
                            </div>
                          </div>
                          <div className="text-aside opacity-100 h-[24px] w-fit overflow-hidden px-[16px] items-center none cursor-pointer">
                            <div className="w-full">
                    ...
                    <span className="text-decoration-none flex items-center relative">
                      <a className="text-decoration-none  border-none inline bg-transparent touch-manipulation cursor-pointer outline-none ">
                        <div className="[@media(min-height:600px)]:my-[4px] [@media(min-height:1264px)]:p-[12px]  [@media(min-height:1264px)]:flex-row [@media(min-height:1264px)]:w-full p-[12px] rounded-[8px] [@media(min-width:1264px)]:w-[220px] [@media(max-width:1264px)]:w-[47px] hover:bg-[#F5F5F5] inline-flex">
                          <div>
                            <div className="overflow-visible flex-col flex bg-transparent items-stretch justify-start relative self-auto w-[24px] h-[24px] transition duration-200">
                              <svg aria-label="Explorar" class="x1lliihq x1n2onr6 x5n08af" fill="currentColor" height="24" role="img" viewBox="0 0 24 24" width="24"><title>Explorar</title><polygon fill="none" points="13.941 13.953 7.581 16.424 10.06 10.056 16.42 7.585 13.941 13.953" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"></polygon><polygon fill-rule="evenodd" points="10.06 10.056 13.949 13.945 7.581 16.424 10.06 10.056"></polygon><circle cx="12.001" cy="12.005" fill="none" r="10.5" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"></circle></svg>
                            </div>
                          </div>
                          <div className="text-aside opacity-100 h-[24px] w-fit overflow-hidden px-[16px] items-center none cursor-pointer">
                            <div className="w-full">
                    ...
                    <span className="text-decoration-none flex items-center relative">
                      <a className="text-decoration-none  border-none inline bg-transparent touch-manipulation cursor-pointer outline-none ">
                        <div className="[@media(min-height:600px)]:my-[4px] [@media(min-height:1264px)]:p-[12px]  [@media(min-height:1264px)]:flex-row [@media(min-height:1264px)]:w-full p-[12px] rounded-[8px] [@media(min-width:1264px)]:w-[220px] [@media(max-width:1264px)]:w-[47px] hover:bg-[#F5F5F5] inline-flex">
                          <div>
                            <div className="overflow-visible flex-col flex bg-transparent items-stretch justify-start relative self-auto w-[24px] h-[24px] transition duration-200">
                              <svg aria-label="Notificaciones" class="x1lliihq x1n2onr6 x5n08af" fill="currentColor" height="24" role="img" viewBox="0 0 24 24" width="24"><title>Notificaciones</title><path d="M16.792 3.904A4.989 4.989 0 0 1 21.5 9.122c0 3.072-2.652 4.959-5.197 7.222-2.512 2.243-3.865 3.469-4.303 3.752-.477-.309-2.143-1.823-4.303-3.752C5.141 14.072 2.5 12.167 2.5 9.122a4.989 4.989 0 0 1 4.708-5.218 4.21 4.21 0 0 1 3.675 1.941c.84 1.175.98 1.763 1.12 1.763s.278-.588 1.11-1.766a4.17 4.17 0 0 1 3.679-1.938m0-2a6.04 6.04 0 0 0-4.797 2.127 6.052 6.052 0 0 0-4.787-2.127A6.985 6.985 0 0 0 .5 9.122c0 3.61 2.55 5.827 5.015 7.97.283.246.569.494.853.747l1.027.918a44.998 44.998 0 0 0 3.518 3.018 2 2 0 0 0 2.174 0 45.263 45.263 0 0 0 3.626-3.115l.922-.824c.293-.26.59-.519.885-.774 2.334-2.025 4.98-4.32 4.98-7.94a6.985 6.985 0 0 0-6.708-7.218Z"></path></svg>
                            </div>
                          </div>
                          <div className="text-aside opacity-100 h-[24px] w-fit overflow-hidden px-[16px] items-center none cursor-pointer">
                            <div className="w-full">
                ...
                <div className="[@media(min-height:768px)]:w-full">
                  <span className="text-decoration-none flex items-center relative">
                    <a className="text-decoration-none  border-none inline bg-transparent touch-manipulation cursor-pointer outline-none ">
                      <div className="[@media(min-height:600px)]:my-[4px] [@media(min-height:1264px)]:p-[12px]  [@media(min-height:1264px)]:flex-row [@media(min-height:1264px)]:w-full p-[12px] rounded-[8px] [@media(min-width:1264px)]:w-[220px] [@media(max-width:1264px)]:w-[47px] hover:bg-[#F5F5F5] inline-flex">
                        <div>
