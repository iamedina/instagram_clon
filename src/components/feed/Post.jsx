...
function Post({ post, setSelectedUserId, setView }) {
    ...
    const toggleLike = async () => {
        ...
        console.log("User que se envía:", user);
    ...
    return (
        <>
                            ...
                            <div>
                                <section className="my-[4px] items-center flex">
                                    <div className="flex">
                                        ...
                                        <div className="cursor-pointer block ">
                                            <div role="button" onClick={openComment} className="p-[8px] justify-center bg-transparent touch--manipulation flex items-center cursor-pointer outline-none text-decoration-none">
                                                <div className="flex justify-center items-center flex-col hover:text-[#737373] transform-stroke duration-75">
                                ...
                                <section className="mb-0">
                                    <div className="overflow-visible m-auto content-stretch bg-transparent flex-col flex self-auto justify-start relative grow items-start flex-wrap transition-all duration-300">
            ...
            <ModalComment open={openComments} close={() => setOpenComments(false)} postId={post.id} userId={user?.id} username={user?.username || post.username}/>
        </>
    );
}
