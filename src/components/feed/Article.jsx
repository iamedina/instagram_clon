                                            ...
                                            <div className="overflow-visible bg-transparent flex-col flex items-stretch self-auto justify-start ">
                                                <div className="w-[100%] h-[100%] text-[100%] flex flex-col items-stretch align-baseline font-inherit ">
                                                    <div className="h-[100%] block overflow-hidden items-stretch absolute inset-0 ">
                                                        <img src="../src/assets/img/imageLogin.png" alt="post" className="object-cover w-[100%] h-[100%] top-0 user-select-none absolute  inset-0 border-0" />
                                                    </div>
                                                </div>
                                                <button aria-label="Atras" className="right-0 cursor-pointer py-[16px] px-[8px] bg-transparent border-none justify-self-center outline-none absolute top-[50%] transform translate-y-[-50%] text-[#000000] dark:text-[#ffffff] text-xs leading-[16px]" >
                                                    <div style={{ backgroundImage: 'url(/rsrc.php/v4/yV/r/6JqvJ6H_bFT.png)', backgroundSize: '440px 411px', backgroundPosition: '-129px -97px', backgroundRepeat: 'no-repeat', height: '30px', width: '30px' }}></div>
                                                </button>
                                                <button aria-label="Siguiente" className="right-0 cursor-pointer py-[16px] px-[8px] bg-transparent border-none justify-self-center outline-none absolute top-[50%] transform translate-y-[-50%] text-[#000000] dark:text-[#ffffff] text-xs leading-[16px]" >
                                                    <div style={{ backgroundImage: 'url(/rsrc.php/v4/yV/r/6JqvJ6H_bFT.png)', backgroundSize: '440px 411px', backgroundPosition: '-160px -97px', backgroundRepeat: 'no-repeat', height: '30px', width: '30px' }}></div>
                                                </button>
                                            </div>
                                        </div>
